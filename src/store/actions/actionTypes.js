...
export const ONE_EVENT_START = "ONE_EVENT_START";
export const ONE_EVENT_SUCCESS = "ONE_EVENT_SUCCESS";
export const ONE_EVENT_FAIL = "ONE_EVENT_FAIL";
export const ONE_EVENT_SUBMIT = "ONE_EVENT_SUBMIT";

export const ALL_EVENT_START = "ALL_EVENT_START";
export const ALL_EVENT_SUCCESS = "ALL_EVENT_SUCCESS";
export const ALL_EVENT_FAIL = "ALL_EVENT_FAIL";
export const ALL_EVENT_SUBMIT = "ALL_EVENT_SUBMIT";